...
# Old Gus' Cypher Reference Document (OG-CRD)

https://callmepartario.github.io/og-crd

This online reference for the Cypher Reference Document (CRD) provides an online quick-reference for the contents of [Cypher Character Rulebook](https://www.montecookgames.com/store/product/cypher-corebooks/) (2026).

Readers are encouraged to support Monte Cook Games, who have so generously made this information available.

This product is an independent production and is not affiliated with Monte Cook Games, LLC. It is published under the [Cypher Open License](http://col.montecookgames.com).
