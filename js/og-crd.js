	...
	if (sectionList[ch].name == "Introduction") { 
		...
		for (let char = 0; char < characteristicList.length; char++) {
			...
			if (characteristicList[char].dt == "Core Character") {
				...
				def += getBody(["<strong>Your core character starts with the following:</strong>", ["8 <a href='#define-stat'>Might</a>, 8 <a href='#define-stat'>Speed</a>, and 8 <a href='#define-stat'>Intellect</a>, plus 6 additional <a href='#define-stat'>Pool</a> points to allocate as you choose", "Able to take three <a href='#define-wound'>minor wounds</a>, three <a href='#define-wound'>moderate wounds</a>, and three <a href='#define-wound'>major wounds</a>", "Your <a href='#define-effort'>Effort</a> score is 1.", "Your <a href='#define-cyphers'>cypher limit</a> is 2.", "<a href='#define-skill'>Freely use</a> light <a href='#define-weapon'>weapons</a>", "Cannot <a href='#define-skill'>freely use</a> any <a href='#define-armor'>armor</a>", "Two <a href='#define-skill'>genre skills</a>, plus an optional third <a href='#define-skill'>genre skill</a> in exchange for an <a href='#define-skill'>inability</a> in a genre skill. Choose one as your background skill, and use it to create a revealing narrative about your past."]]);
