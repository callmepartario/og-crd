...
const abilityList = [
	...
	{ name: "Always Tinkering", ref: ["CCR 106", "CCR 130",], effects: ["You build a single-use technological device. You can choose its effect from the <a href='#low-power-manifest-cyphers'>Low-Power Manifest Cyphers</a> table. Your device counts toward your cypher limit (or the limit of anyone you give the device to). If you are already at your cypher limit, your choice of one of your current cyphers shorts out, had to be salvaged for parts to create the new device, or something similar, and the new device takes its place.", "Ten minutes to build.", "<em>At tier 3:</em> You can choose a <a href='#low-power-manifest-cyphers'>low</a> or <a href='#medium-power-manifest-cyphers'>medium-power manifest cypher</a> as a single-use device.", "<em>At tier 6:</em> You can choose a <a href='#low-power-manifest-cyphers'>low-</a>, <a href='#medium-power-manifest-cyphers'>medium-</a>, or <a href='#advanced-power-manifest-cyphers'>advanced-power manifest cypher</a> as a single-use device.", ], sidebar: "<p>Each time you use Always Tinkering, you can choose a different manifest cypher you want to build.</p>", }, 
