...
const abilityList = [
	...
	{ name: "Craft Device", ref: ["CCR 106",], cost: 5, plus: true, pool: "Intellect", effects: ["You build a new&mdash;but somewhat fragile&mdash;device if you succeed at a difficulty 3 engineering task. You can choose its effect from the Low-Power Manifest Cyphers table. The resulting device is not a cypher, doesn't count toward your cypher limit, and usually isn't limited to one use; instead, it has a <a href='#define-artifacts'>depletion</a> of 1 in 1d6. The device is small enough that you can carry it.", "One hour to build.", "<em>At tier 3:</em> If you apply a level of Effort to this ability you can choose a medium-power manifest cypher as your device.", "<em>At tier 6:</em> If you apply two levels of Effort to this ability you can choose an advanced-power manifest cypher as your device.", ], }, 
