...
const characteristicList = [
	...
	{ dt: "Stat", ref: ["CCR 11", "CCR 287&ndash;288", "CCR 291", ], dd: ["Your statistics or \"stats.\" are Might, Speed, and Intellect. Each has two components: Pool and Edge.", ["<strong>Might:</strong> Use this stat for physical <a href='#define-tast'>tasks</a> that require strength, power, or endurance.", "<strong>Speed:</strong> Use this stat for physical <a href='#define-tast'>tasks</a> that require agility, flexibility, or fast reflexes.", "<strong>Intellect:</strong> Use this stat for mental <a href='#define-tast'>tasks</a> that require force of will, memory, or mental power.", "<strong>Pool:</strong> Your Might, Speed, and Intellect each have a Pool of points. Spend Pool points for to use <a href='#define-effort'>Effort</a> or activate abilities.", "<strong>Edge:</strong> Subtract your edge from spent Pool point costs for a task&mdash;for example, if you spend 1 Intellect point to activate <a class='og-ability' href='#define-ability-blast'>Blast</a>, and spend 3 Intellect points to apply a level of <a href='#define-effort'>Effort</a>, the total cost is 4 Intellect points. If your Intellect Edge is 1, the total cost for the is reduced to 3 Intellect points."], ], }, 
	{ dt: "Skill", ref: ["CCR 12", "CCR 18&ndash;19", "CCR 287", "CCR 290",], dd: ["Skills represent knowledge you can improve to lower the <a href='#define-difficulty'>difficulty</a> of relevant <a href='#define-task'>tasks</a>.", ["<strong>Genre Skills:</strong> Each <a href='#define-genre'>genre</a> has its own list of skills, and more skills are possible. In most campaigns, fluency in a language is a skill.", "<strong>Combat Skills:</strong> Skills related to <a href='#define-attack'>attacking</a> or <a href='#define-defend'>defending</a>. Combat skills are tier-restricted.", "<strong>Tier-Restricted:</strong>  You must be <a href='#define-tier'>tier 2</a> to become trained, and <a href='#define-tier'>tier 4</a> to become specialized in a tier-restricted skill. Abilities can create exceptions&mdash;for example, <a class='og-ability' href='#define-ability-expert-combatant'>Expert Combatant</a>.", ], ], }, 
	...
	{ dt: "Effort", ref: ["CCR 12", "CCR 287&ndash;288", "CCR 291"], dd: ["You can pay 3 points from the appropriate stat Pool to apply one level of Effort on a task. Your Effort score is the maximum number of levels of Effort you can apply (up to a maximum of 6). You can apply Effort for each task or action, but be careful how quickly you exhaust your <a href='#define-stat'>stat</a> Pool points.", ["<strong>Ease:</strong> You can apply a level of Effort to ease the <a href='#define-difficulty'>difficulty</a> of a <a href='#define-task'>task</a>.", "<strong>Damage:</strong> Apply a level of Effort to increase the <a href='#define-damage'>damage</a> of an attack by 3 (or by 2 for <a href='#define-attack'>area attacks</a>)&mdash;if the attack succeeds.", "<strong>Ability Effects:</strong> Some <a href='#define-abilities'>abilities</a> allow you to apply Effort in unique ways&mdash;for example, increasing the maximum level of a foe you can affect by 1.", "<strong>Multiple Levels of Effort</strong>: Each additional level Effort costs 2 points, so the cost from Effort is 1 + 2 &times; levels of Effort used. You can assign each level of Effort's effects separately.", "<strong>Free Level of Effort:</strong> A free level of Effort doesn't cost Pool points, and allows you to exceed your Effort score. It doesn't allow you to exceed the maximum of six levels of Effort on a <a href='#define-task'>task</a>.", ], "<strong><em>Effort can't ease a task more than six steps.</em></strong>", ], }, 
...
const resourceList = [
	...
	{ name: "Rest", cost: 0, description: "Resting, relaxing, visiting friends or loved ones, or otherwise taking it easy.", }, 
...
const skillList = [
	...
	{ name: "Crafting", ref: ["CCR 20"], description: "You're well-versed in one aspect of crafting, as appropriate to your game's setting. Options include cooking; weaving; metalworking or blacksmithing; leatherworking; brewing, vinting, or distilling; woodworking; pottery; gun and ammunition smithing; or something else available for the genre.", sidebar: "<p>Crafting training allows you to craft (and, if appropriate, repair) related items using your <a href='#define-resource-points'>resources</a>.</p>", }, 
	...
	{ name: "Hacking", ref: ["CCR 22"], description: "You can exploit weaknesses in a computer or computerized machine to gain unauthorized access, manipulate its intended function, damage it, or otherwise contravene its regular operation. Hacking requires a connection and some way to manipulate the system, such as with a keyboard or more advanced interface, and requires at least a few rounds or even minutes of effort, and perhaps much longer, depending on the hack desired.", sidebar: "<p>Attempting to exploit, break, or warp a computerized system&mdash;as opposed to operating a system as intended&mdash;is a hacking task.</p>", }, 
	...
	{ name: "Intimidation", ref: ["CCR 22"], description: "You're good at swaying others with threatening words or a fearsome presence.", sidebar: "<p>Any negative social <a href='#define-interact'>interaction</a> is covered by intimidation.</p>", }, 
	...
	{ name: "Navigation", ref: ["CCR 22"], description: "Your sense of direction is well honed, and you are familiar with using maps, cues from the environment, or tools appropriate to the setting to find your way through an unfamiliar or confusing landscape.", }, 
...
gmintrusions: ["Quick movements sometimes lead to dropped items, slipping on uneven ground, or going the wrong way by accident.", ], abilities: [
		[
			{ name: "Fleet of Foot", }, 
			{ name: "Get Out", }, 
			{ name: "Recover Faster", }, 
...
const abilityList = [
	...
	{ name: "Always Mighty", ref: ["CCR 137", "CCR 206", "CCR 208",], effects: ["Every time you use a recovery, if your Might Pool isn't already full, you get 1 extra point to restore to your Might Pool. You can select this ability up to three times.", ], }, 
	...
	{ name: "Always Tinkering", ref: ["CCR 106", "CCR 130",], effects: ["You build a single-use technological device. You can choose its effect from the <a href='#low-power-manifest-cyphers'>Low-Power Manifest Cyphers</a> table. Your device counts toward your cypher limit (or the limit of anyone you give the device to). If you are already at your cypher limit, your choice of one of your current cyphers shorts out, had to be salvaged for parts to create the new device, or something similar, and the new device takes its place.", "Ten minutes to build.", "<em>At tier 3:</em> You can choose a <a href='#low-power-manifest-cyphers'>low</a> or <a href='#medium-power-manifest-cyphers'>medium-power manifest cypher</a> as a single-use device.", "<em>At tier 6:</em> You can choose a <a href='#low-power-manifest-cyphers'>low-</a>, <a href='#medium-power-manifest-cyphers'>medium-</a>, or <a href='#advanced-power-manifest-cyphers'>advanced-power manifest cypher</a> as a single-use device.", ], sidebar: "<p>Each time you use <a class='og-ability' href='#define-ability-always-tinkering'>Always Tinkering</a>, you can choose a different <a href='#define-cypher-manifest'>manifest cypher</a> you want to build.</p>", }, 
	...
	{ name: "Armored Body", gr: true, ref: ["CCR 138",], note: "rank 2+", effects: ["You are very resistant to damage due to your body being composed of rock or metal, your incredible toughness, or a similar reason.", "You ignore minor wounds.", "You can take an additional moderate wound and major wound.", ], }, 
	...
	{ name: "Blink of an Eye", gr: true, ref: ["CCR 205",], cost: 4, pool: "Speed", effects: ["You move up to 1,000 feet (300 m). (This movement doesn't hinder your tasks.) Last action."], }, 
	...
	{ name: "Craft Device", ref: ["CCR 106",], cost: 5, plus: true, pool: "Intellect", effects: ["You build a new&mdash;but somewhat fragile&mdash;device if you succeed at a difficulty 3 engineering task. You can choose its effect from the <a href='#low-power-manifest-cyphers'>Low-Power Manifest Cyphers</a> table. The resulting device is not a cypher, doesn't count toward your cypher limit, and usually isn't limited to one use; instead, it has a <a href='#define-artifacts'>depletion</a> of 1 in 1d6. The device is small enough that you can carry it.", "One hour to build.", "<em>At tier 3:</em> If you apply a level of Effort to this ability you can choose a medium-power manifest cypher as your device.", "<em>At tier 6:</em> If you apply two levels of Effort to this ability you can choose an advanced-power manifest cypher as your device.", ], }, 
	...
	{ name: "Fantastic Armament", gr: true, ref: ["CCR 139",], effects: ["You have a weapon, either mystical or technological in nature. You can freely use this weapon. Work with your GM to determine its origin, its history, and whether it's a ranged or melee weapon.", "You wield this weapon as a medium weapon that inflicts an additional +2 damage.", "Your weapon also has one power of its own. Choose an ability from the <a href='#low-power-manifest-cyphers'>Low-Power Manifest Cyphers</a> or <a href='#medium-power-manifest-cyphers'>Medium-Power Manifest Cyphers</a> table. You can use that power as your action, costing 3 Intellect if it's a low-power ability or 5 Intellect if it's a medium-power ability.", "If you lose your weapon, you can (depending on your skill) craft a replacement or arrange for one to be made for you, requiring 1d6 days of concerted effort.", ], }, 
	{ name: "Fantastic Vehicle", gr: true, ref: ["CCR 139",], effects: ["You have a vehicle, either mystical or technological in nature, that you can freely use. Work with your GM to determine whether it's a flying vehicle, a burrowing vehicle, a land vehicle, a watercraft, or something else.", "Your vehicle can comfortably carry you and up to six other creatures of your size.", "Your vehicle also has one power of its own. Choose an ability from the <a href='#low-power-manifest-cyphers'>Low-Power</a> or <a href='#medium-power-manifest-cyphers'>Medium-Power Manifest Cyphers</a> table. You can use that power as your action, costing 3 Intellect if it's a low-power ability or 5 Intellect if it's a medium-power ability.", "If you lose your vehicle, you can (depending on your skill) craft a replacement or arrange for one to be made for you, requiring 1d6 days of concerted effort.", ], }, 
	...
	{ name: "Flurry", ref: ["CCR 55",], cost: 2, pool: "Speed", effects: ["After making a light unarmed attack, as an extra action on your turn you make another light unarmed attack against the same target or a different one. Action.", "<em>At tier 3:</em> You can make a third light unarmed attack as a third action on your turn.", ], sidebar: "<p>A few character abilities allow you to treat your unarmed attack as a <a href='#define-weapon'>medium weapon</a> instead of a <a href='#define-weapon'>light weapon</a>. You can't use <a class='og-ability' href='#define-ability-flurry'>Flurry</a> with a medium unarmed attack.</p>", }, 
	...
	{ name: "Hard to See", dupminor: true, gr: true, ref: ["CCR 160", "CCR 205",], effects: ["When you move, you are a blur. It is impossible to make out your identity as you pass by someone at speed.", "In addition, if you do nothing but move on your turn, your dodge and stealth tasks are eased by three steps until your next turn. Enabler."], }, 
	...
	{ name: "Power Cypher Use", gr: true, ref: ["CCR 142",], effects: ["You can bear one additional cypher or power boost cypher at a time.", ], }, 
	...
	{ name: "Powerful Blast", gr: true, ref: ["CCR 140",], effects: ["You can emit a long-range blast of energy inflicting 4 damage with a successful attack roll, or 6 points if you use a Last action to attack. Work with your GM to determine the type of energy comprising your blast (cold, electricity, fire, and so on). Action or Last action.", ], }, 
	...
	{ name: "Prepare Spell", dupminor: true, ref: ["CCR 53", "CCR 81", "CCR 154",], effects: ["Each day you can pick a different magical effect and cast it as a spell. Choose a <a href='#low-power-manifest-cyphers'>low-power manifest cypher</a>. After spending ten minutes preparing, you gain that cypher's effect as a spell (a character special ability). You can cast that spell as an action, costing 2 Intellect. This spell does not count toward your cypher limit. Unlike when using a cypher, you do not lose this spell after casting it.", "As part of making a ten-hour recovery, you can change which cypher you've taken as a spell. Changing which cypher you have prepared as a spell ends all of your durations of the previous prepared spell.", "You can select this ability up to three times (as a character advancement or in place of a new focus ability), allowing you to choose one, two, or three cyphers each day as spells.", "Ten minutes to prepare a cypher as a spell; action to cast a cypher as a spell.", "<em>At tier 3:</em> You can use this ability to choose a <a href='#low-power-manifest-cyphers'>low-</a> or <a href='#medium-power-manifest-cyphers'>medium-power cypher</a> as a spell. You can cast a <a href='#medium-power-manifest-cyphers'>medium-power cypher</a> spell as an action, costing 4 Intellect.", "<em>At tier 6:</em> You can use this ability to choose a <a href='#low-power-manifest-cyphers'>low-</a>,  <a href='#medium-power-manifest-cyphers'>medium-</a>, or <a href='#advanced-power-manifest-cyphers'>advanced-power cypher</a> as a spell. You can cast an <a href='#advanced-power-manifest-cyphers'>advanced-power cypher</a> spell as an action, costing 6 Intellect.", ], }, 
	...
	{ name: "Second Focus", gr: true, ref: ["CCR 136",], effects: ["You have two foci instead of one. At tier 1 you gain two abilities from each of them. When you advance to a new tier, you gain a new ability from each focus.", ], }, 
	...
	{ name: "Super Combatant", gr: true, ref: ["CCR 130", "CCR 131", "CCR 134", "CCR 135", "CCR 137",], effects: ["You are trained in a specific attack of your choice, such as eye lasers, punches, or guns; or in a broader category of attacks such as light bashing weapons, light bladed weapons, light ranged weapons, medium bashing weapons, medium bladed weapons, medium ranged weapons, and so on.", "<em>At tier 2:</em> You can choose to become specialized in the same attack method you chose at tier 1, but you must gain the skill normally (such as from a character advancement).", "<em>At tier 6:</em> You can become an expert in a specific attack method (either the one you chose at tier 1 or another weapon skill you're already specialized in), but you must gain the skill normally.", ], }, 
	{ name: "Superhero Versatility", gr: true, ref: ["CCR 144",], effects: ["Gain 12 Pool points, dividing them among your Pools as you wish.", ], }, 
	{ name: "Superheroics", gr: true, ref: ["CCR 129", "CCR 130", "CCR 131", "CCR 132", "CCR 133", "CCR 134", "CCR 135", "CCR 137"], effects: ["Choose one Pool: Might, Speed, or Intellect. For tasks using your chosen Pool, add your rank to the amount of Effort you can apply, allowing you to apply additional levels of Effort to tasks in that Pool.", "In addition, you can choose to push yourself so hard that you take a moderate wound in exchange for two free levels of Effort you can apply to tasks in your chosen Pool (as long as this doesn't push you past your Effort limit for that Pool).", "Finally, add your rank as a bonus to your recovery, with those points going only into the Pool you have chosen.", ], }, 
...
function getSection(ch) {
	...
	if (sectionList[ch].name == "Introduction") { 
		...
		chx += "</div>";
		chx += "</div>";
		chx += "<div class='og-border mt-2 mb-2'></div>";
		return chx;
	}
		...
		for (let char = 0; char < characteristicList.length; char++) {
			...
			if (characteristicList[char].dt == "Core Character") {
				...
				def += getBody(["<strong>Your core character starts with the following:</strong>", ["8 <a href='#define-stat'>Might</a>, 8 <a href='#define-stat'>Speed</a>, 8 <a href='#define-stat'>Intellect</a>", "+6 <a href='#define-stat'>Pool</a> points to allocate as you choose", "Able to take three <a href='#define-wound'>minor wounds</a>, three <a href='#define-wound'>moderate wounds</a>, and three <a href='#define-wound'>major wounds</a>.", "<a href='#define-effort'>Effort</a> of 1", "<a href='#define-cyphers'>Cypher limit</a> of 2", "<a href='#define-skill'>Freely use</a> light <a href='#define-weapon'>weapons</a>", "Can't <a href='#define-skill'>freely use</a> any <a href='#define-armor'>armor</a>", "Two <a href='#define-skill'>genre skills</a>, plus an optional third <a href='#define-skill'>genre skill</a> in exchange for an <a href='#define-skill'>inability</a> in a genre skill"]]);
				def += "<p class='og-hang og-tooltip-omit'><strong>Background Skill:</strong> Choose one of your skills as a background skill. Use it to create a revealing narrative about your past.</p>";
				def += "<p class='og-hang og-tooltip-omit'><strong>Equipment:</strong> If your <a href='#define-genre'>genre</a> doesn't assign you any <a href='#define-equipment'>equipment</a>, you probably start with at least a set of appropriate clothing and enough <a href='#define-currency'>currency</a> for a moderately-priced item. Work with the GM to ensure your character's equipment makes sense.</p>";
				def += "<p class='og-hang og-tooltip-omit'><strong>Character Sentence:</strong> The character sentence is <em>\"I am an adjective noun who verbs\"</em>. The adjective is your <a href='#define-descriptor'>descriptor</a>&mdash;and maybe your <a href='#define-species'>species</a>. The noun is your <a href='#define-type'>type</a>. The verb is your <a href='#define-focus'>focus</a>. Your available choices are informed by the game's <a href='#define-genre'>genre</a>.</p>";
				...
				// build descriptors
					...
					for (let d = 0; d < descriptorList.length; d++) {
						...
						desc += "<ul>";
						desc += "<li>+2 <a href='#define-stat'>" + descriptorList[d].pool + " Pool</a></li>";
						desc += "<li><a href='#define-skill'>Trained</a> in ";
				...
				// build species
					...
					for (let sp = 0; sp < speciesList.length; sp++) {
						...
						species += "</div>";
						if (speciesList[sp].name == "Human") {
							species += getBody(["<em>In a game where all <a href='#define-character'>PCs</a> are human, the GM decides if you use the Human species option.</em>"]);
						}
				...
				// build types
					...
					for (let t = 0; t < typeList.length; t++) {
						...
						type += "</div>";
						type += "<p><strong>You gain the following characteristics:</strong></p>";
						type += "<ul>";
						...
						type += "</ul>";
						// background options
						type += "<div class='accordion og-tooltip-omit'>" // open accordion
						if (typeList[t].equipment != undefined) {
							type += "<div class='accordion-item'>"; // open item
							type += "<h5 class='accordion-header' id='" + createID(typeList[t].name + "equipment") + "'>";
							type += "<button class='accordion-button collapsed text-uppercase p-2' type='button' data-bs-toggle='collapse' data-bs-target='#" + createID(typeList[t].name + "equipment") + "-collapse' aria-expanded='false' aria-controls='" + createID(typeList[t].name + "equipment") + "-collapse'>" + typeList[t].name + " Equipment Bundle </button>";
							type += "</h5>";
							type += "<div id='" + createID(typeList[t].name + "equipment") + "-collapse' class='accordion-collapse collapse' aria-labelledby='" + createID(typeList[t].name + "equipment") + "'>"; // open collapse
							type += "<div class='accordion-body p-2 pt-3 og-stripe'>"; // open body
							type += getBody([typeList[t].equipment]);
							type += "</div>"; // close body
							type += "</div>"; // close collapse
							type += "</div>"; // close item
						}
						type += "<div class='accordion-item'>"; // open item
						type += "<h5 class='accordion-header' id='" + createID(typeList[t].name + "backgrounds") + "'>";
						type += "<button class='accordion-button collapsed text-uppercase p-2' type='button' data-bs-toggle='collapse' data-bs-target='#" + createID(typeList[t].name + "backgrounds") + "-collapse' aria-expanded='false' aria-controls='" + createID(typeList[t].name + "backgrounds") + "-collapse'>" + typeList[t].name + " Background Options </button>";
						type += "</h5>";
						type += "<div id='" + createID(typeList[t].name + "backgrounds") + "-collapse' class='accordion-collapse collapse' aria-labelledby='" + createID(typeList[t].name + "backgrounds") + "'>"; // open collapse
						type += "<div class='accordion-body p-2 pt-3 og-stripe'>"; // open body
						type += "<ul>"
						for (let b = 0; b < typeList[t].backgrounds.length; b++) {
							type += "<li class='mb-1'>" + typeList[t].backgrounds[b] + "</li>";
						}
						type += "</ul>";
						type += "</div>"; // close body
						type += "</div>"; // close collapse
						type += "</div>"; // close item
						type += "</div>"; // close accordion
						type += "<div class='mb-3'></div>"; // space accordion
						// abilities for tooltips
						type += createHeader(5, createID("type-" + typeList[t].name + "-abilities"), (typeList[t].name + " Abilities"), "og-tooltip-omit");
						type += "<p><strong>You gain the following abilities:</strong></p>";
				...
				// build foci
					...
					for (let f = 0; f < focusList.length; f++) {
						...
						for (let t = 0; t < focusList[f].abilities.length; t++) {
							...
							for (let a = 0; a < focusList[f].abilities[t].length; a++) {
								...
								focusDef += "<li class='og-nowrap'>" + abilityname + "</li>";
							}
							focusDef += "</ul>";
							focusDef += "</td>";
							focusDef += "</tr>";
						...
						for (let t = 0; t < focusList[f].abilities.length; t++) {
							...
							for (let a = 0; a < focusList[f].abilities[t].length; a++) {
								...
								// genre restriction
								if (focusList[f].abilities[t][a].genre == true) { faDef += "<ul class='og-list-tag'><li class='og-tag-danger'><a href='#define-abilities-genre-restricted'>Genre-Restricted</a></li></ul>"; }
								...
								if (focusList[f].abilities[t][a].req != undefined) {
									...
									if (focusList[f].abilities[t][a].preq != undefined) {
										for (let p = 0; p < focusList[f].abilities[t][a].preq.length; p++) {
											...
											faDef += "<a class='og-ability' href='#" + createID("define-focus-" + focusList[f].name + "-" + focusList[f].abilities[t][a].preq[p]) + "'>" + abilityname + "</a>";
									...
									for (let r = 0; r < focusList[f].abilities[t][a].req.length; r++) {
										...
										if (abilityname != undefined && abilityname.charAt(abilityname.length - 3) == "-" && abilityname.charAt(abilityname.length - 2) == "v") { abilityname = abilityname.slice(0, -3); }
										faDef += "<a class='og-ability' href='#" + createID("define-focus-" + focusList[f].name + "-" + focusList[f].abilities[t][a].req[r]) + "'>" + abilityname + "</a>";
								...
								faDef += "<li class='og-list-ability og-tooltip-focus-ability'>" + getAbility(focusList[f].abilities[t][a].name, false) + "</li>", 
								faDef += "</ul>";
					...
					chx += createSidebar(getBody(["Each session, the GM intrudes up to twice per PC. You also a trigger a GM intrusion when you <a href='#define-roll'>roll a 1</a>, but triggered intrusions don't cause PCs to earn XP.", "It's not a good idea to hoard XP, and the GM might force you spend some on <a href='#define-character-advancement'>character advancement</a>."]));
					...
					def += getBody([["<strong>Rerolling:</strong> Spend 1 XP to reroll any dice roll and use the better result&mdash;for example, an <a href='#define-roll'>action roll</a>, <a href='#define-recovery'>recovery roll</a>, <a href='#define-artifacts'>depletion</a> roll&mdash;even a roll you didn't make. You can spend additional XP to keep rerolling.", "<strong>Player Intrusion:</strong> Spend 1 XP for a player intrusion, altering something in the campaign to benefit your character (no action required). Player intrusion usually introduces a change to the circumstances rather than changing your PC. If the GM refuses your intrusion, you don't spend any XP.", "<strong>Lucky Shot:</strong> If you know there's a foe nearby but you have no idea where they are&mdash;for example, they're invisible, or you're blinded by complete darkness. Normally, you can't attack, but if you spend 1 XP, you can attack that's hindered four steps."]]);
		...
		for (let g = 0; g < genreList.length; g++) {
			...
			if (genreList[g].type != undefined) { 
				...
				if (genreList[g].genre == "Superheroes" && genreList[g].subgenre == undefined) {
					...
					alert += getBody(["You can adapt or reskin <a href='#define-type'>types</a> to superhero by consulting the table and making the following changes:", ["Replace bonuses to <a href='#define-stat'>Pool</a> points with new totals and maximums (determined by rank).", "Add the <a class='og-ability' href='#define-ability-superheroics'>Superheroics</a> ability.", "Add number of additional points to the <A href='#define-stat'>Pool</a> you choose for the <a class='og-ability' href='#define-ability-superheroics'>Superheroics</a> ability (determined by rank).", "Add number of <a href='#define-power-shift'>power shifts</a> (determined by rank).", ]]);
			...
			if (genreList[g].advancement != undefined) { 
				...
				if (genreList[g].abilitiesmid != undefined | genreList[g].abilitieshigh != undefined) { 
					...
					if (genreList[g].abilitiesorigin != undefined) { 
						...
						alert += getGenreList(genreList[g].genre, genreList[g].subgenre, "abilitiesorigin", "list-unstyled og-qr og-qr-abilities", false);
						chx += createAlert(alert);
					}// origin
					...
					if (genreList[g].abilitiesmid != undefined) { 
						...
						if (genreList[g].abilitiesmid != undefined) { alert += getGenreList(genreList[g].genre, genreList[g].subgenre, "abilitiesmid", "list-unstyled og-qr og-qr-abilities", false); }
					}
					// high-tier
					if (genreList[g].abilitieshigh != undefined) { 
						...
						if (genreList[g].abilitieshigh != undefined) { alert += getGenreList(genreList[g].genre, genreList[g].subgenre, "abilitieshigh", "list-unstyled og-qr og-qr-abilities", false); }
					}
					chx += createAlert(alert);
				}
		...
		def += "</div>"; // close table cell
		def += "<div class='d-table-cell align-top pt-1'>"; // open table cell
		def += getBody(["You <a href='#define-roll'>roll the die</a>&mdash;a <strong>d20</strong>. If the roll meets or exceeds the target number, you succeed. If not, you probably fail."]);
		def += "</div>"; // close table cell
		def += "</div>"; // close table row
		def += "</div>"; // close table
		...
		def += getBody(["Something your character does during is an action. The GM decides if your action requires a <a href='#define-task'>task</a>. In situations where several characters are acting at once, <a href='#define-time'>timekeeping</a> affects how different kinds of actions are resolved:", ["<strong>First Actions:</strong> You can choose to resolve a First action before the initiative order in a round, or as a regular action. Either way, you can also take a <strong>Follow-up action</strong> on your turn that isn't an attack&mdash;for example, moving an <a href='#define-range'>immediate distance</a>. Any action can be a First action if you spend the previous round preparing it.", "<strong>Last Actions:</strong> Last actions resolve after the initiative order of a round ends. Performing a Last action takes you the entire round, so you can't do anything else&mdash;not even move an <a href='#define-range'>immediate distance</a>.", "<strong>Extra Action:</strong> Sometimes, an effect lets you can take an extra or additional action on your turn&mdash;usually something specific, for example, making a second attack or attempting a stealth task after attacking a foe.", "<strong>Ready an Action:</strong> You can delay your action until a triggering condition is met&mdash;for example, waiting for a foe to come around the corner before attacking.", "<strong>Doing Something Else:</strong> The rules covers a number tasks, but aren't comprehensive. Try anything interesting, logical, and story-based!", ], "If more than one character takes a First or Last action, the GM resolves each type of action in initiative order."]);
		...
		def += getBody(["Difficulty and determine your chance to succeed a <a href='#define-task'>task</a>. The target number when <a href='#define-roll'>rolling the die</a> is difficulty &times; 3.", ["<strong>Level:</strong> NPCs, objects, and effects have a level, which is the difficulty of <a href='#define-task'>tasks</a> made in opposition to them.", "<strong>Easing:</strong> You can lower the difficulty applying relevant <a href='#define-skill'>skills</a> (up to three steps), <a href='#define-asset'>assets</a> (up to two steps), and <a href='#define-effort'>Effort</a> (up to six steps), or by having favorable circumstances.", "<strong>Hindering:</strong> Unfavorable circumstances or an <a href='#define-skill'>inability</a> raise difficulty."]]);
		...
		def += getBody(["Damage is resolved differently for <a href='#define-damage-to-pcs'>PCs</a>, <a href='#define-damage-to-npcs'>NPCs</a>, and <a href='#define-damage-to-objects'>objects</a>."]);
		...
		def += getBody(["You can influence NPCs and other creatures, usually by talking with them. Trying to bluff, bribe, calm, or otherwise interact with an NPC may require an Intellect roll against the NPC's level. Any truthful positive social interaction is covered by <a href='#define-skill-charm'>charm</a>. Any untruthful positive social interaction is covered by <a href='#define-skill-deception'>deception</a>. Any negative social interaction is covered by <a href='#define-skill-intimidation'>intimidation</a>.", "Interacting usually requires a common language or other workable method of communication. Relying on tone of voice and gestures is probably hindered by at least one step.", ["<strong>NPC Allies:</strong> NPC allies are usually only temporary. Usually, an NPC ally uses their action (on your turn) to <a href='#define-asset'>help</a> you with a task if the GM agrees they can help. In combat, decide if the ally helps you <a href='#define-attack'>attack</a> or <a href='#define-defend'>defend</a>."]]);
		...
		alert += "<p class='small'><span class='og-nowrap pe-3'>&dagger; &mdash; <em>Ability with major differences</em></span><span class='og-nowrap'>&ddagger; &mdash; <em>Genre-restricted ability</em></span></p>";
		alert += "<ul class='list-unstyled og-qr'>";
		...
		for (let alpha = 0; alpha < abilitySortList.length; alpha++) {
			...
			for (let a = 0; a < abilityList.length; a++) {
				if (abilityList[a].name.charAt(0) == abilitySortList[alpha]) {
					chx += "<li class='og-list-ability' id='" + createID("ability-" + abilityList[a].name) + "'><div class='og-tooltip-ability' id='define-" + createID("ability-" + abilityList[a].name) + "'>" + getAbility(abilityList[a].name, true) + "</div></li>";
