...
function getSection(ch) {
	...
	if (sectionList[ch].name == "Introduction") { 
		...
		def += getBody(["Difficulty and determine your chance to succeed a <a href='#define-task'>task</a>. The target number when <a href='#define-roll'>rolling the die</a> is difficulty &times; 3.", ["<strong>Level:</strong> NPCs, objects, and effects have a level, which is the difficulty of <a href='#define-task'>tasks</a> made in opposition to them.", "<strong>Easing:</strong> You can lower the difficulty applying relevant <a href='#define-skill'>skills</a> (up to 3 steps), <a href='#define-asset'>assets</a> (up to two steps), and <a href='#define-effort'>Effort</a> (up to six steps), or by having favorable circumstances.", "<strong>Hindering:</strong> Unfavorable circumstances or an <a href='#define-skill'>inability</a> raise difficuty."]]);
